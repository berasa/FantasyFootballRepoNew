...
$sel = "SELECT * FROM player_details WHERE FantPosition='QB'";
...
echo "<table id=\"myTable2\"><tr><th onclick=\"sortTable2(0)\">Rank</th><th onclick=\"sortTable(1)\">Player Name</th><th onclick=\"sortTable(2)\">Team</th> <th>Position</th><th onclick=\"sortTable2(4)\">Rushing Yds</th><th onclick=\"sortTable2(5)\">Rushing TD</th><th onclick=\"sortTable2(6)\">Cmp</th><th onclick=\"sortTable2(7)\">Y/A</th></tr>";
foreach ($connect->query($sel) as $namerow ){
     echo "<tr>";
       ...
       echo "<td>".$namerow[ "RushingYds" ]." </td><td>".$namerow[ "RushingTD" ]." </td><td>".$namerow[ "passescomplete" ]." </td><td>".$namerow[ "RushingYardsperAttempt" ]." </td>";
