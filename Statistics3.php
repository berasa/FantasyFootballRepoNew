...
$sel = "SELECT * FROM player_details WHERE FantPosition='TE'";
...
echo "<table id=\"myTable2\"><tr><th onclick=\"sortTable2(0)\">Rank</th><th onclick=\"sortTable(1)\">Player Name</th><th onclick=\"sortTable(2)\">Team</th> <th>Position</th><th onclick=\"sortTable2(4)\">Rec</th><th onclick=\"sortTable2(5)\">Y/R</th></tr>";
foreach ($connect->query($sel) as $namerow ){
     echo "<tr>";
       ...
       echo "<td>".$namerow[ "Receptions" ]." </td><td>".$namerow[ "ReceivingYdsperattempt" ]." </td>";
